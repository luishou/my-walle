...
class ProdConfig(Config):
    ...
    # 数据库设置 @TODO
    SQLALCHEMY_DATABASE_URI = 'mysql://root:Jd&Walle.@localhost:3306/walle?charset=utf8'
    ...
    MAIL_USE_SSL = True
    MAIL_USE_TLS = False
    MAIL_DEFAULT_SENDER = 'xyyzhsl@163.com'
    MAIL_USERNAME = 'xyyzhsl@163.com'
    MAIL_PASSWORD = 'Hsl19911226'
